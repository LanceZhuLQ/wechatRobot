...
tuling_api_key = 'cb93dfd89f4f4ff69eb8041a37251db4'
...
listen_friend_names = 'Robot'  # 需要监听的人名称，使用备注名更安全，允许多个用|分隔，如：主管|项目经理|产品狗
listen_friend_groups = 'RobotTest'  # 在这些群里监听好友说的话，匹配模式：包含“唯一集团工作群”的群
